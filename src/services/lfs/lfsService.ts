...
export class LfsService {
    ...
    public async downloadLfsFile(
        ...
        if (this.cache) {
            ...
            if (cached) {
                console.log('[LfsService] Cache hit for LFS file:', path);
                return cached;
            }
        }

        console.log('[LfsService] Downloading LFS file (cache miss):', {
            path,
        ...
        try {
            ...
            console.log('[LfsService] Successfully downloaded LFS file:', {
                path,
                size: content.length
            });
